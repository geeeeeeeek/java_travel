      ...
      >
        <div>
          <a-form ref="myform" :label-col="{ style: { width: '80px' } }" :model="modal.form" :rules="modal.rules">
            <a-row :gutter="24">
              <a-col span="24">
                <a-form-item label="景区名称" name="title">
              ...
              <a-col span="12">
                <a-form-item label="星级">
                  <a-select placeholder="请选择" allowClear v-model:value="modal.form.level">
                    <a-select-option key="5A" value="5A">5A</a-select-option>
                    <a-select-option key="4A" value="4A">4A</a-select-option>
                    <a-select-option key="3A" value="3A">3A</a-select-option>
                    <a-select-option key="2A" value="2A">2A</a-select-option>
                  </a-select>
                </a-form-item>
              </a-col>
              <a-col span="12">
